		        	...
		        	<form method="post">
			        	<div class="modal-body">
							...
							<input type="text" class="form-control" name="details" placeholder="Details"><br>
			          		<button name="submit" type="submit" class="btn btn-danger" style="margin: auto;">Submit</button>  
			      		</div>
		      		</form>  
	    		</div>
			</div>
		...
		<div class="modal fade" id="addChap">
	    	<div class="modal-dialog">
	    		<div class="modal-content">
		        	<form method="post">
			        	<div class="modal-body">
							<input type="text" class="form-control" name="nameStory" placeholder="Which story"><br>
